...
import us.rise8.tracker.config.auth.platform1.PlatformOneAuthenticationFilter;
import us.rise8.tracker.helpers.MockJWT;
...
public class PlatformOneAuthenticationFilterTest {
    ...
    @Test
    public void should_get_bearer_from_request() throws Exception {
    ...
    @Test
    public void should_throw_when_no_keycloak_subscriber() throws Exception {
        var request = new MockHttpServletRequest();
        var response = new MockHttpServletResponse();
        var filterChain = new MockFilterChain();
