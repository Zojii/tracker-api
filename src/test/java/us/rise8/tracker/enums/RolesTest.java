package us.rise8.tracker.enums;
...
public class RolesTest {
    ...
    public void canStreamEnum() {
        assertThat((int) Roles.stream().count()).isEqualTo(2);
    }

    @Test
    public void should_get_permission_by_long() {
    ...
    @Test
    public void should_update_permission_map() {
        Map<Roles, Boolean> rolesMap = new HashMap<Roles, Boolean>();
        rolesMap.put(Roles.ADMIN, true);
